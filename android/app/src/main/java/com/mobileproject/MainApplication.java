...
public class MainApplication extends NavigationApplication {
  ...
  protected List<ReactPackage> getPackages() {
    ...
    return Arrays.<ReactPackage>asList(new VectorIconsPackage(), new ImagePickerPackage());
  }
   ...
   * Arrays.<ReactPackage>asList(new MainReactPackage(), new ImagePickerPackage(),
   ...
   * mReactNativeHost; }
   * 
   * @Override public void onCreate() { super.onCreate(); SoLoader.init(this,
   * false); }
   **/
